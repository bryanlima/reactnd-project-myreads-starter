...
describe('', () => {
  it('Render <BookShelf /> component', () => {
    ...
    const wrapper = shallow(<BookShelf { ...mockBookShelf } />);
    expect(wrapper.find(books[0].id));
  });
});