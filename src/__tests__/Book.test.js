...
//     // sinon.spy(Book.prototype, 'componentDidMount');
...
//   // it('Bloqueia opção de mover livro igual a estante do livro', () => {

//   //   sinon.spy(Book.prototype, 'componentDidMount');
//   //   const wrapper = mount(<Book {...mockBookProps} />);
//   //   wrapper.find(book.id);
